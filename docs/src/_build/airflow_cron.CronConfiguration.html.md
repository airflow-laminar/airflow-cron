...
### *pydantic model* airflow_cron.CronConfiguration[[source]](../../../_modules/cron_pydantic/models.html.md#CronConfiguration)

Bases: `BaseModel`

Environment and named jobs rendered as one crontab file.

#### *field* job *: dict[str, [CronJobConfiguration](airflow_cron.CronJobConfiguration.html.md#airflow_cron.CronJobConfiguration)]* *[Required]*
