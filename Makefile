...
lint-py:  ## lint python with ruff
	python -m ruff check airflow_cron
	python -m ruff format --check airflow_cron
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix airflow_cron
	python -m ruff format airflow_cron
...
test:  ## run python tests
	python -m pytest -v airflow_cron/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v airflow_cron/tests --cov=airflow_cron --cov-report term-missing --cov-report xml
